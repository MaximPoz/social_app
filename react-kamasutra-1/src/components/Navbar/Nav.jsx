...
const Nav = () => {
    return (<nav className={s.nav}>
        <div className={s.item}><NavLink to="/Profile" activeClassName={s.activeLink}>Profile</NavLink></div> {/* NavLink при нажатии на Profile отрисовывает в URL to="/Profile1" */}
        ...
        <hr />
        <div className={s.item}><NavLink to="/Friends" activeClassName={s.activeLink}>Friends online</NavLink></div>
